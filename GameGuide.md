...
<details>
  ...
  <p>Если вы наткнулись на <b>баг в игре</b>, вы можете сообщить о нём. Информация будет передана разработчикам.
  <ul>
...
<h1 id="tag1">🕯️ Удаление/переустановка игры</h1>
...
<h1 id="tag2">🗺️ Установка игровых карт</h1>
