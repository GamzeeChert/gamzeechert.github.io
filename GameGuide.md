...
<h1 id="tag6">🗿 Настройка NPC</h1>

Вы можете настроить NPC, выбрав ему скин и анимацию. Для установки скина вам необходимо навестить на туловище NPC, а для выбора анимации вам необходимо навестись на его голову, нажать на кнопку интерактирования и выбрать понравившиеся вам скин и анимацию.
...
<!-- <h1 id="tagIDHERE">🪽 Режим полёта</h1>
