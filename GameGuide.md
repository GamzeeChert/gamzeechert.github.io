...
1 Способ📱:
  ...
  ¹•¹Если у вас Android 11 и выше, то скачайте ещё Shizuku и запустите откладку по Wi-Fi.
  ²Скачайте файл карты — он будет в загрузках.
  ²•¹Если вы через Телеграм — Нажмите на 3 точки -> Сохранить в загрузках.
  ³Переместите из папки загрузки Файл "(Число)_(Название).clm" или "(Число)_(Название).clm.msg.gz"
По адресу: Android\data\com.SimpleSandbox2\files\Save Maps\
