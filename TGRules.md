...
16. Распространение **ложной информации**, а также **использование команды @admin без весомой причины**;
17. Попрошайничество;
...
* Если Вас не устраивает поведение какого-либо участника, Вы можете написать **жалобу** о нём, использовав команду @admin. 
...
###### 📝 [Раздел для модераторов и стажёров](./TGmodRules.md)

`Правила обновлены 24.08.2025`
