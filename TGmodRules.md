...
<body>
    ...
    <!--<p>За использование <strong>нецензурной лексики</strong> в чатах, а также <strong>попытку обхода фильтра запрещённых слов</strong> будет выдаваться <strong>предупреждение</strong> <em>[/warn 6h Обход фильтра]</em>.</p> -->
        ...
        <ol>
            ...
            <li>Отправка <strong>материалов</strong> с тегом 18+ (Шок-контент) <em>[/warn 18+]</em>;</li>
            <li>Отправка <strong>стикеров</strong> с тегом 18+ <em>[/warn 18+]</em>;</li>
            ...
            <li> 🆕 Содержание <strong>в профиле аккаунта</strong> неподобающего контента<em>[/warn Неподобающий профиль]</em>;</li>
