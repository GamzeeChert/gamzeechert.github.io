...
<details>
    ...
    <li>🙊 <strong>Ограничитель (Модератор на стажировке)</strong>
      <ul>
        <li>Отображается в списке Персонала;</li>
