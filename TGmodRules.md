    ...
    <li>
      <details>
        ...
        <ul>
          ...
          <li><b>Блокировка/разблокировка:</b><br>
            <b>ban</b> - (👑⚜👮🏻‍♂️👷🏻) Заблокировать пользователя;<br>
            <b>unban</b> - (👑⚜👮🏻‍♂️👷🏻) Разблокировать пользователя.<br>
            <b>delban</b> - (👑⚜👮🏻‍♂️👷🏻🛃) Заблокировать пользователя и удалить его сообщение;
          </li>
          <li><b>Выдача/снятие предупреждений:</b><br>
            <b>warn</b> - (👑⚜👮🏻‍♂️👷🏻) Предупредить пользователя;<br>
            <b>unwarn</b> - (👑⚜👮🏻‍♂️👷🏻) Снять предупреждение с пользователя;<br>
            <b>delwarn</b> - (👑⚜👮🏻‍♂️👷🏻🛃) Предупредить пользователя и удалить его сообщение;<br>
            <b>warns</b> - (👑⚜👮🏻‍♂️👷🏻) Просмотр и управление предупреждениями пользователя;
          </li>
          <li><b>Выдача/снятие мьютов:</b><br>
            <b>mute</b> - (👑⚜👮🏻‍♂️👷🏻🙊) Замьютить пользователя;<br>
            <b>unmute</b> - (👑⚜👮🏻‍♂️👷🏻🙊) Размьютить пользователя;<br>
            <b>delmute</b> - (👑⚜👮🏻‍♂️👷🏻🛃) Замьютить пользователя и удалить его сообщение.
          </li>
        </ul>
      </details>
    </li>
    ...
    <li>
      <details>
        ...
        <ul>
          ...
          <li><b>Блокировка/разблокировка:</b><br>
            <b>multiban, mban</b> - (👑⚜👮🏻‍♂️👷🏻) Заблокировать нескольких пользователей;<br>
            <b>multiunban, munban</b> - (👑⚜👮🏻‍♂️👷🏻) Разбанить нескольких пользователей;
          </li>
          <li><b>Выдача/снятие мьютов:</b><br>
            <b>multimute, mmute</b> - (👑⚜👮🏻‍♂️👷🏻) Замьютить нескольких пользователей;<br>
            <b>multiunmute, munmute</b> - (👑⚜👮🏻‍♂️👷🏻) Размьютить нескольких пользователей.
          </li>
        </ul>
      </details>
    </li>
