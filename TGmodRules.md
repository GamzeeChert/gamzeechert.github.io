...
<br>**staff** - (❓|👥) Отобразить Персонал группы;
<br>**rules** - (❓|👥) Отправить правила группы;
<br>**link** - (❓|👥) Отправить ссылку на группу;
<br>**me** - (❓|👥) Отправить в приватный чат сообщение с данными аккаунта;
...
<br>**silence** - (👑⚜👮🏻‍♂️) Глобальное молчание в группе;
...
<br>**graphic** - (👑⚜👮🏻‍♂️) Тренд количества участников в группе в виде графика;
<br>**trend** - (👑⚜👮🏻‍♂️) тренд количества подписчиков в группе в текстовом формате;
